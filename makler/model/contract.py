...
class Contract(Base):
    ...
    time_created = Column("time_created", types.DateTime(timezone=True), server_default=func.now())
    time_updated = Column("time_updated", types.DateTime(timezone=True), onupdate=func.now())
